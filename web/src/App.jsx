...
import LinearGenerator from "./pages/LinearGenerator.jsx";
...
const NAV_ITEMS = [
  ...
  { to: "/gestion/linear", label: "Generador Linear", match: "/gestion/linear" },
  ...
  return (
    <div className="app">
      {!isKiosco && (
        <header className="topbar">
          <div>
            ...
            <div className="subtitle">Gestión operativa: administración, asistencia, leads, pedagogía y proyectos</div>
          </div>
      ...
      <Routes>
        ...
        <Route path="/gestion/linear" element={<LinearGenerator />} />
